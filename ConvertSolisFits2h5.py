...
if __name__ == '__main__':
    ...
    p.add_argument(
        'flist', help='file(s) to convert to one HDF5 file', nargs='+')
    ...
    p.add_argument('-c', '--coordinates', help='wgs84 coordinates of sensor (lat,lon,alt_m)',
                   nargs=3, default=(nan, nan, nan), type=float)
    P = p.parse_args()

    Pm = {'rotccw': P.rotccw, 'transpose': P.transpose,
