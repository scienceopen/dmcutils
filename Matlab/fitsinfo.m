function out=fitsinfo(filename,verbose)
%FITSINFO returns header information from a FITS file.
%
...
%  onto the screen.
%
%  n_hdu=fitsinfo(filename)
%  value=fitsinfo(filname,'keyword')
%  n_hdu=fitsinfo(filename,'silent_mode')
% 
