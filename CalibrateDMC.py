...
if __name__ == '__main__':
    ...
    p = ArgumentParser(
        description='do plate scaling for 2013 Jan 13 CMOS data')
    p.add_argument('infn', help='image data file name')
    p.add_argument(
        '-o', '--outfn', help='platescale data file name to write', default=mkstemp('.h5')[1])
    p.add_argument('--latlon', help='wgs84 coordinates of cameras (deg.)',
                   nargs=2, default=(66.986330, -50.943941), type=float)
